...
include 'multibiblelinker_ru.php';
...
11. Римские номера книг: II Кор. 5:3-4; I Цар. 17:34–41; I Паралипоменон 14:9<br/>
12. Проверка разделителей: Мф. 3:4–6,8 (рус.) и Мт. 3,4–6.8 (укр.)<br/>
13. Проверка переводов: Матфея 3:4 РБО2011, Матфея 3:4&nbsp;РБО2011, Матфея 3:4–4:4 РБО2011, Матфея 3:4  РБО2011, Матфея 3:4 &nbsp;РБО2011, Матфея 3:4&nbsp; РБО2011, Матфея 3:4а РБО2011, Матфея 3:4а  РБО2011, Матфея 3:4а; 5:6б РБО2011 и Флм. 5 РБО2011<br/>
14. Проверка на ложные срабатывания: Через старейшин Откровение откровение проблемам прим.<br/>
...
echo $isRoman ? 'да<br/>' : 'нет<br/>';
echo 'Исправлять названия книг на стандартные: ';
echo $doCorrection ? 'да<br/>' : 'нет<br/>';
echo 'Язык ввода: ';
echo ($languageIn == 'ua') ? 'украинский<br/>' : 'русский<br/>';
echo 'Язык вывода: ';
echo ($languageOut == 'ua') ? 'украинский<br/>' : 'русский<br/>';
