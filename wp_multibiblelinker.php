...
/*
	...
	Description: This plugin is designed to help people referring mostly to Russian Bible. Once activated, it will find all texts that look like references to Biblical texts and replace them with link to actually biblical chapter and verses.
	Version: 1.6.1
...
$fileLanguageIn = "local/bible_links_arrays_".$bParams->languageIn."_in.php";
$fileLanguageOut = "local/bible_links_arrays_".$bParams->languageOut."_out.php";
